...
class TestGetGrandPrixNames(unittest.TestCase):
    ...
    def test_load_all_grands_prix(self):
        grand_prix_names = get_grand_prix_names.GetGrandPrixNames(datetime.date(2017,12,31))
    ...
    def test_races_before(self):
        grand_prix_names = get_grand_prix_names.GetGrandPrixNames(datetime.date(2017,5,1))
